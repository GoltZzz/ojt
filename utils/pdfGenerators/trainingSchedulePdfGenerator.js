    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            doc
                ...
                .fillColor(colors.primary)
                .text("TRAINING DETAILS", { align: "center" });
            ...
            const rowHeight = 60; // Adjusted height for content
            let currentY = tableTop;

            // Draw table header
            doc.rect(30, currentY, tableWidth, 30).fill(colors.primary);
            ...
            doc
                .fontSize(fonts.normal)
                .fillColor(colors.dark)
                .text(schedule.proposedActivities, 40 + labelColWidth + 10, currentY + 15, {
            ...
            doc
                .fontSize(fonts.heading)
                .fillColor(colors.primary)
                .text("How Activities Will Be Performed", 40, currentY + 15);

            // Content column
            doc
                .fontSize(fonts.normal)
                .fillColor(colors.dark)
                .text(schedule.performanceMethod, 40 + labelColWidth + 10, currentY + 15, {
                    width: contentColWidth - 20,
                    align: "left",
                    lineGap: 2,
                });
            ...
            if (schedule.additionalNotes) {
                ...
                doc
                    .fontSize(fonts.normal)
                    .fillColor(colors.dark)
                    .text(schedule.additionalNotes, 40 + labelColWidth + 10, currentY + 15, {
                        width: contentColWidth - 20,
                        align: "left",
                        lineGap: 2,
                    });
            ...
            if (debugSchedule.proposedActivities && debugSchedule.proposedActivities.length > 100) {
                debugSchedule.proposedActivities = debugSchedule.proposedActivities.substring(0, 100) + "...";
            }
            if (debugSchedule.performanceMethod && debugSchedule.performanceMethod.length > 100) {
                debugSchedule.performanceMethod = debugSchedule.performanceMethod.substring(0, 100) + "...";
            }
            if (debugSchedule.expectedOutput && debugSchedule.expectedOutput.length > 100) {
                debugSchedule.expectedOutput = debugSchedule.expectedOutput.substring(0, 100) + "...";
            }
            if (debugSchedule.additionalNotes && debugSchedule.additionalNotes.length > 100) {
                debugSchedule.additionalNotes = debugSchedule.additionalNotes.substring(0, 100) + "...";
            }
            console.error(
